    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            Varyings vert(Attributes input)
            {
                ...
                float sway = sin(_Time.y * _WindSpeed + input.positionOS.x * 0.5 + input.positionOS.z * 0.5) * _WindStrength * heightMask;
        ...
        Pass
        {
            ...
            v2f vert(appdata v)
            {
                ...
                float sway = sin(_Time.y * _WindSpeed + v.vertex.x * 0.5 + v.vertex.z * 0.5) * _WindStrength * heightMask;
                ...
                o.pos = TransformObjectToHClip(
                    float4(v.vertex.xyz + v.normal * _OutlineWidth * 0.1, 1)
                );
