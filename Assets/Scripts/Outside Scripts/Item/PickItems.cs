...
public class PickItems : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        //Debug.Log("PlayerAnimation found: " + playerAnimation);
    }
    ...
    void Equip(GameObject item)
    {
        ...
        playerAnimation.isHoldingItem = true;
        //Debug.Log("Holding item set to TRUE");
    ...
    void Drop()
    {
        ...
        playerAnimation.isHoldingItem = false;
